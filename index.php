  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
		...
		<i class="bi bi-cart"></i> <span id="cart-item" class="badge badge-danger"></span></a>
      </li>
    </ul>
  </div>
</nav>
...
<div class="container">
    ...
    <div class="row mt-2 pb-3">
        <?php
        include 'config.php';
        $stmt = $conn->prepare("SELECT * FROM piggybanks");
        $stmt->execute();
...
<div class="col-sm-6 col-md-4 col-lg-4">
    <div class="card p-2 border-secondary mb-2">
        <img src="<?= $row['product_image'] ?>" class="card-img-top" style="max-width: 100%; height: auto;">
...
function load_cart_item_number(){
    $.ajax({
        ...
        success: function (response) {
            var totalQty = parseInt(response); // Assuming response is a string representing the total quantity
            $("#cart-item").html(totalQty); // Update the content of #cart-item with the total quantity
        }
    });
}
